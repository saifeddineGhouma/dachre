...
.siblings('input').prop('checkedcp',false)
...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            <div class="panel panel-success  ">
                <div class="panel-heading "><h3 style="color: #000;text-align: center;">Modifier  Contrat Automobiles</h3></div>
                
                <form action="{{url('autos/modif',$contrat->id)}}" method="post" >
                {{ csrf_field() }}
                    <div class="panel-body" >
                        ...
                        <div class="form-group col-md-4  {{ $errors->has('numero') ? ' has-error' : '' }}">
                                ...
                                <input class="form-control" type="text" name="cp" value="{{$contrat->assureur->nom}}"id="example-text-input" >
                            ...
                            <div class="form-group col-md-4  {{ $errors->has('type_auto') ? ' has-error' : '' }}">
                                ...
                                <select class="form-control"  name="type_auto">
                                    ...
                                    <option value="Moteur " @if ($contrat->type_auto=="Moteur") selected @endif >Moteur</option>
                                    <option value="Voiture" @if ($contrat->type_auto=="Voiture") selected @endif>Voiture</option>
                        ...
                        <div class=" col-md-12">
                            ...
                            <div class="form-group col-md-4 {{ $errors->has('echeance') ? ' has-error' : '' }}">
                                ...
                                <div class="col-10">
                                    <input class="form-control" type="date" value="{{$contrat->echeance}}"name="echeance" id="echeance">
 ...
 @if($contrat->client->type=="Personne physique") selected @endif

               
                                        >Personne physique</option>
                                        <option value="Personne morale"

 @if($contrat->client->type=="Personne morale") selected @endif
                     ...
                     @foreach($contrat->autos as $auto)
                            <div class="col-md-12" id="test"  >
                                <div class="form-group col-md-6 {{ $errors->has('immatriculation') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-10" >
                                        <input class="form-control" type="text" name="immatriculation[]" value="{{$auto->immatriculation}}" >
                                ...
                                <div class="form-group col-md-6 ">
                                    <div class="form-group col-md-12 {{ $errors->has('mise_en_circulation') ? ' has-error' : '' }} ">
                                        ...
                                        <div class="col-10">
                                            <input class="form-control" type="date" name="mise_en_circulation[]"value="{{$auto->mise_en_circulation}}" >
                            ...
                            <div class="form-group col-md-4 {{ $errors->has('classe') ? ' has-error' : '' }} ">
                                ...
                                <input class="form-control" type="text" name="classe[]" value="{{$auto->classe}}" id="example-text-input">
                            ...
                            <div class="form-group col-md-4 {{ $errors->has('nbr_de_sinistre') ? ' has-error' : '' }} ">
                                ...
                                <input class="form-control" type="text" name="nbr_de_sinistre[]" value="{{$auto->nbr_de_sinistre}}" id="example-text-input">
                            ...
                            <div class="form-group col-md-4 {{ $errors->has('nbr_de_sinistre') ? ' has-error' : '' }} ">
                                ...
                                <input class="form-control" type="text" name="num_choissir[]" value="{{$auto->num_choissir}}" id="example-text-input">
                                @if ($errors->has('nbr_de_sinistre'))
                                <span class="help-block">
                                    <strong>{{ $errors->first('nbr_de_sinistre') }}</strong>
                                </span>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group col-md-6 ">
                                    <div class="form-group col-md-12 {{ $errors->has('nbre_de_place') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-10">
                                            <input class="form-control" type="text" name="nbre_de_place[]"value="{{$auto->nbre_de_place}}" >
                                    ...
                                    <div class="form-group col-md-12 {{ $errors->has('genre') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-10">
                                            ...
                                            <select class="form-control" name="genre[]">
                                                ...
                                                <option value="Voiture particulière"
                                                  @if($auto->genre=="Voiture mixte") selected @endif

                                                >Voiture particulière</option>
                                                <option value="Voiture mixte"
                                                  @if($auto->genre=="Voiture mixte") selected @endif
                                                >Voiture mixte</option>
                                                <option value="Utilitaire I"
                                                 @if($auto->genre=="Utilitaire I") selected @endif

                                                >Utilitaire I</option>
                                                <option value="Utilitaire II"
@if($auto->genre=="Utilitaire II") selected @endif
                                                >Utilitaire II</option>
                                                <option value="Engins de chantiers"
@if($auto->genre=="Engins de chantiers") selected @endif


                                                >Engins de chantiers</option>
                                                <option value="Tracteur agricole"
@if($auto->genre=="Tracteur agricole") selected @endif


                                                >Tracteur agricole</option>
                                                <option value="Moissonneuse batteuse"
@if($auto->genre=="Moissonneuse batteuse") selected @endif

                                                >Moissonneuse batteuse</option>
                                                <option value="Taxi"
@if($auto->genre=="Taxi") selected @endif

                                                >Taxi</option>
                                                <option value="Auto-école"
@if($auto->genre=="Auto-école") selected @endif
                        ...
                        <div class="col-md-12">
                            ...
                            <table class="table table-bordered" id="dynamic_field">
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" name="prix[]" value="{{$prime->prix}}" class="form-control name_list" /></td>
                                    <td><input type="text" name="espece[]" value="{{$prime->espece}}" class="form-control name_list" /></td>
                                    <td><input type="text" name="check[]" value="{{$prime->check}}" class="form-control name_list" /></td>
                        ...
                        <div class="form-group col-md-12{{ $errors->has('observation') ? ' has-error' : '' }} ">
                            ...
                            <div class="col-10">
                                <textarea class="form-control" id="exampleTextarea" name="observation" rows="3">{{$contrat->observation}}</textarea>
