  ...
  <div class="row">
    <div class="col-md-10 col-md-offset-1">
      <div class="panel panel-default">
        ...
        <form action="{{url('rds/modif',$contrat->id)}}" method="post" enctype="multipart/form-data">
          ...
          <div class="panel-body" >
            ...
            <div class="col-md-12">
              <div class="form-group col-md-6 {{ $errors->has('numero') ? ' has-error' : '' }} ">
                ...
                <input class="form-control" type="text" name="numero" id="example-text-input"value="{{$contrat->numero}}" >
              ...
              <div class="form-group col-md-6 {{ $errors->has('numero') ? ' has-error' : '' }} ">
               ...
               <input type="text" class="form-control" name="cp" id="cp" value="{{$contrat->assureur->nom}}">
                @if ($errors->has('numero'))
                <span class="help-block">
                  <strong>{{ $errors->first('numero') }}</strong>
                </span>
            ...
            <div class=" col-md-12">
              <div class="form-group col-md-3 {{ $errors->has('date') ? ' has-error' : '' }} ">
                ...
                <div class="col-10">
                  <input class="form-control" type="date" name="date" value="{{ $contrat->date }}" id="example-url-input">
                  @if ($errors->has('date'))
                  <span class="help-block">
              ...
              <div class="form-group col-md-3 {{ $errors->has('duree') ? ' has-error' : '' }}  ">
                ...
                <div class="col-10">
                  <select class="form-control" id="sel1" name="duree">
                    ...
                    <option value="S" @if($contrat->duree=="S") selected @endif>Semestrielle </option>
                    <option value="Fermer" @if($contrat->duree=="Fermer") selected @endif>Fermer</option>
                  </select>                              </div>
                </div>
                ...
                <div class="form-group col-md-3 {{ $errors->has('echeance') ? ' has-error' : '' }}  ">
                  ...
                  <div class="col-10">
                    <input class="form-control" type="date" name="echeance" id="echeance" value="{{$contrat->echeance}}">
              ...
              <div class="col-md-12">
                <div class="form-group col-md-6 {{ $errors->has('identite') ? ' has-error' : '' }} ">
                  ...
                  <div class="col-10">
                    <input class="form-control" type="text" name="identite" id="identite" value="{{$contrat->client->identite}}">
                ...
                <div class="form-group col-md-6 ">
                  <div class="form-group col-md-12 {{ $errors->has('cin') ? ' has-error' : '' }} ">
                    ...
                    <div class="col-10">
                      <input class="form-control" type="text" name="cin"value="{{$contrat->client->cin}}" >
                      @if ($errors->has('cin'))
                      <span class="help-block">
              ...
              <div class="col-md-12">
                <div class="form-group col-md-6 {{ $errors->has('tel') ? ' has-error' : '' }}  ">
                  ...
                  <div class="col-10">
                    <input class="form-control" type="telephone" name="tel" value="{{$contrat->client->tel}}">
                    @if ($errors->has('tel'))
                    <span class="help-block">
                ...
                <div class="form-group col-md-6 ">
                  <div class="form-group col-md-12 {{ $errors->has('adresse') ? ' has-error' : '' }}  ">
                    ...
                    <div class="col-10">
                      <input class="form-control" type="text" name="adresse"value="{{$contrat->client->adresse}}" >
                ...
                <div class="form-group col-md-6 ">
                  ...
                  <div class="col-10">
                    <select class="form-control"name="risque[]" id="Re_Prime">
                      ...
                      <option value="RC" @if ($rd->nature=="RC") selected @endif>Responsabilité Civile</option>
                      <option value="Multirisques Habitations" @if ($rd->nature=="Multirisques Habitations") selected @endif>Multirisques Habitations</option>
                      <option value="Multirisques Profesionnelles"@if ($rd->nature=="Multirisques Profesionnelles") selected @endif>Multirisques Profesionnelles</option>
                      <option value="Individuelle Accident" class="Re_Prime" @if ($rd->nature=="Individuelle Accident") selected @endif>Individuelle Accident</option>
                      <option value="Incendie"  @if ($rd->nature=="Incendie") selected @endif>Incendie</option>
                      <option value="Vol" @if ($rd->nature=="Vol") selected @endif>Vol</option>
                      <option value="Tous Risques Chantiers" @if ($rd->nature=="Tous Risques Chantiers") selected @endif>Tous Risques Chantiers</option>
                      <option value="Engins de chantiers" @if ($rd->nature=="Engins de chantiers") selected @endif>Engins de chantiers</option>
                      <option value="RC décennale" @if ($rd->nature=="RC décennale") selected @endif>RC décennale</option>
                      <option value="Transport" class="Re_Prime" @if ($rd->nature=="Transport") selected @endif>Transport</option>
                      <option value="Corps Maritime" class="Re_Prime" @if ($rd->nature=="Corps Maritime") selected @endif>Corps Maritime</option>
                      <option value="Assistance en Voyage" class="Re_Prime" @if ($rd=="Assistance en Voyage") selected @endif>Assistance en Voyage</option>
                      <option value="Tous Risques Ordinateurs" @if ($rd->nature=="Tous Risques Ordinateurs") selected @endif>Tous Risques Ordinateurs</option>
                      <option value="Mortalité de bétails" class="Re_Prime" @if ($rd->nature=="Mortalité de bétails") selected @endif>Mortalité de bétails</option>
                      <!--option value="Groupes Maladies">Groupes Maladies</option-->
                      <option value="Grêle" @if ($rd->nature=="Grêle") selected @endif>Grêle</option>
                      <option value="Ecolia" @if ($rd->nature=="Ecolia") selected @endif>Ecolia</option>
                      @endforeach
                    </select>
                  </div>
                </div>
                ...
                <div class="set-form">
                  <table class="table table-bordered" id="dynamic_field">
                    <tr>
                      ...
                      @foreach($contrat->rds as $rd)
                        @foreach($rd->garanties as $garntie )
                    <tr>
                      <td><input type="text" name="situation" value="{{$garntie->situation}}" class="form-control name_list" /></td>
                      <td><input type="file" name="file" value="{{$garntie->file}}" class="form-control name_list" /></td>
              ...
              <table class="table table-bordered" id="dynamic_field_prime">
                ...
                <tr>
                  <td><input type="date" name="name[]" value="{{$prime->date_prime}}" class="form-control name_list" /></td>
                  <td><input type="text" name="prix[]" placeholder="{{$prime->prix}}" class="form-control name_list" /></td>
                  <td> 
            ...
            <div class="form-group col-md-12 {{ $errors->has('Observation') ? ' has-error' : '' }}  ">
              ...
              <div class="col-10">
                <textarea class="form-control" id="exampleTextarea" id="observation"name="observation" rows="3">{{ $contrat->observation }}</textarea>
